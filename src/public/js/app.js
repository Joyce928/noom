...
function changeNickname(event) {
  ...
  socket.emit("change_nickname", changeNameInput.value);
}
...
function handleRoomSubmit(event) {
  ...
  const changeNicknameForm = room.querySelector("form");
...
// 위 코드는 이와 같아. socket.on("room-change", (msg) => console.log(msg));
